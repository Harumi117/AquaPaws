...
このアプリは、犬の体重に基づいて1日に必要な水分量を計算したり、犬の年齢を人間年齢に換算したりできるシンプルなツールです。愛犬の健康管理に役立ててください！🌟
...
- **年齢計算（人間年齢換算）**  
  犬の年齢とサイズ（小型犬・中型犬・大型犬）を入力すると、人間年齢に換算したおおよその年齢を計算できます。サイドバーから「年齢計算」ページを開いて利用してください。
